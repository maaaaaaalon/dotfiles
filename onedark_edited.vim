...
hi Yellow          guifg=#ffffbf    guibg=NONE    gui=NONE
hi Pink            guifg=#b46896    guibg=NONE    gui=NONE
hi DarkGreen       guifg=#008080    guibg=NONE    gui=NONE
hi LightGreen      guifg=#80ffcc    guibg=NONE    gui=NONE
hi Orange          guifg=#FFD6A5    guibg=NONE    gui=NONE
hi DarkOrange      guifg=#ff8000    guibg=NONE    gui=NONE
hi Blue            guifg=#2c90a9    guibg=NONE    gui=NONE
hi LightBlue      guifg=#a2d2ff    guibg=NONE    gui=NONE
hi Grey            guifg=#68788a    guibg=NONE    gui=NONE
hi Lavender        guifg=#d9b3ff   guibg=NONE    gui=NONE
hi Violette        guifg=#733696   guibg=NONE    gui=NONE
hi LightPink       guifg=#ffc6ff    guibg=NONE    gui=NONE
hi Brown           guifg=#d0b8ac    guibg=NONE    gui=NONE
"hi DarkBrown       guifg=#994d00    guibg=NONE    gui=NONE
hi DarkBrown       guifg=#663300    guibg=NONE    gui=NONE
hi Red           guifg=#f5a7a3    guibg=NONE    gui=NONE
hi Wine           guifg=#720026    guibg=NONE    gui=NONE
"hi Wine           guifg=#990033    guibg=NONE    gui=NONE
"hi Wine           guifg=#b3003b    guibg=NONE    gui=NONE
hi White           guifg=#ffffff    guibg=NONE    gui=NONE
...
hi CursorLine      guifg=NONE       guibg=#20262d    gui=NONE
...
hi jsp guifg=#e9d5c1    guibg=NONE    gui=NONE

hi link StringDelimiter    jsp
hi link Character          jsp
hi link Number             LightGreen  
...
hi pInclude   guifg=#008080    guibg=NONE    gui=NONE
...
hi link Structure      Lavender 
hi link Typedef         Brown
hi link Include         pInclude
...
hi DiffDelete    guifg=#ffffff    guibg=#f07b75    gui=NONE
...
" Spelling
hi SpellBad      guifg=NONE    guibg=NONE    gui=UNDERCURL    guisp=#f07b75
...
hi SignifySignDelete    guifg=#f07b75    guibg=NONE    gui=NONE
